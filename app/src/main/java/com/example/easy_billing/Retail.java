    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSelectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Retail.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Button bill1 = findViewById(R.id.btnBillRet_id);
        ImageView back = findViewById(R.id.left_icon);

        bill1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Retail.this,BillGenerate.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Retail.this,SelectTariff.class);
                startActivity(intent);
            }
        });
